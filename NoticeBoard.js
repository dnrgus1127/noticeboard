...
currentPage = getParameterByName("pageIndex");

slicePage = localStorage.getItem("slicePage");
if (slicePage == null) {
  slicePage = 5;
} else {
}
...
let fetch_str = "http://localhost:3000/posts?_sort=id&_order=DESC";
// fetch_str = "http://localhost:3000/posts?_sort=tag";
    ...
    for (let index = 0; index < data.length; index++) {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        if (i === 1) {
          ...
          a.href = `/Notice/PostIn.html?index=${arr[0]}`;
